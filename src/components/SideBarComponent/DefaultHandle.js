...
import React, { useState } from "react";
import { Layout, Menu, Badge, Typography, Space, Dropdown, Input,message, Select } from "antd";
import {
  DashboardOutlined,
  ContactsOutlined,
  ProductOutlined,
...
import { Link } from "react-router-dom";
import switchProfile from "../LoginComponents/SwitchProfile";
...
const DefaultHandle = ({ children }) => {
  ...
  const handleSwitchProfile = async () => {
    try {
      const response = await switchProfile(selectedRole);
              ...
              <Dropdown
                overlay={
                  <Menu>
                    ...
                    <Menu.Item key="switch_user" icon={<UserSwitchOutlined />}>
                      <Select
                        defaultValue="user"
                        style={{ width: 120 }}
                      ...
                      <a onClick={handleSwitchProfile}>Switch Profile</a>
                    </Menu.Item>
                  </Menu>
                }
              >
